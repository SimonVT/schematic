...
public class TableWriter {
    ...
    public List<String> createInsertDescription(int dbVersion, String descriptionTableName) {
        List<String> list = new ArrayList<>();
        for (VariableElement element : columns) {
            DataType dataType = element.getAnnotation(DataType.class);

            String s = "INSERT INTO " + descriptionTableName +
                    " (" +
                    DbDescriptionInterface.TABLE_NAME + " ," +
                    DbDescriptionInterface.DB_VERSION + " ," +
                    DbDescriptionInterface.COLUMN_NAME + " ," +
                    DbDescriptionInterface.COLUMN_TYPE +
                    ") VALUES ('" +
                    name + "', " +
                    dbVersion + ", '" +
                    element.getConstantValue().toString() + "', '" +
                    dataType.value() +
                    "')";
            list.add(s);
        }
